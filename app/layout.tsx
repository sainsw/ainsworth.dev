...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={cx(
        'text-foreground bg-background dark:text-foreground dark:bg-[#111010]',
        GeistSans.variable,
        GeistMono.variable
      )}
    >
      ...
      <body className="antialiased text-foreground bg-background dark:text-foreground dark:bg-[#111010]">
