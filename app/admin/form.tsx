...
function DeleteButton({ isActive }) {
  ...
  return (
    <button
      className={cx(
        'px-3 py-2 border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded p-1 text-sm inline-flex items-center leading-4 text-gray-900 dark:text-gray-100 mb-8 transition-colors',
        {
