  ...
  return (
    <div className="flex flex-wrap gap-4 p-2">
      {skills.map((skill, index) => (
        <span
          key={index}
          className="border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 rounded px-3 py-1.5 text-sm text-neutral-900 dark:text-neutral-100 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors"
