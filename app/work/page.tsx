...
function ExperienceCard({ name, dates, post, description, iconId, url, technologies = [] }: {
  ...
  return (
    <div className="border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 rounded px-3 py-4 w-full grid grid-cols-[auto,1fr] gap-4">
  ...
  return (
    <section>
      ...
      <div className="mt-12">
        ...
        <div className="border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 rounded px-3 py-4 mb-8">
      ...
      <div className="mt-12">
        ...
        <div className="border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 rounded px-3 py-4">
