        ...
        <div>
            ...
            >
                ...
                <textarea
                    ...
                    name="message"
                    required
                    className="h-64 pl-4 pr-32 py-2 mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full border-gray-300 rounded-md bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                />
                <SubmitButton />
            </form>
            {state?.message && (
...
function SubmitButton() {
    ...
    return (
        <button
            className="flex items-center justify-center absolute right-1 bottom-1 px-2 py-1 font-medium h-8 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded w-16 disabled:opacity-50"
            disabled={pending}
            type="submit"
        >
            {pending ? '...' : 'Send'}
