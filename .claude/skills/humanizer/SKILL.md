...
metadata:
  ...
  vendored: "2026-08-05 at commit 523374d"
---

<!--
Vendored copy of blader/humanizer (MIT, see LICENSE alongside this file).
Update with:
  curl -fsSL https://raw.githubusercontent.com/blader/humanizer/main/SKILL.md \
    -o .claude/skills/humanizer/SKILL.md
then re-apply the frontmatter description and metadata block above.

Site-specific notes that override nothing in the skill, but save you a decision:
  - Keep the emoji in page headings (hello, I'm Sam 👋 / work & experience 💼).
    They are deliberate site chrome, not §18 decoration.
  - Keep lowercase headings on pages. Keep sentence case in post headings.
  - Keep curly apostrophes and quotes. §19 is a false positive here; the whole
    site uses them and they are not what gives a post away.
  - Leave code blocks, mermaid sources, frontmatter, and link targets alone.
-->
