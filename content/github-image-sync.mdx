...
graph TD
    ...
    F --> H[Content Hash]
    G --> H
    H --> I[Versioned Files<br/>avatar-{hash}.webp<br/>avatar-{hash}.jpg]
    I --> J[Update Version File<br/>lib/version.js]
    J --> K[Next.js Build]
...
Here's the feature in action - the same avatar with different seasonal borders:
