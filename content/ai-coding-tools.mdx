...
1. The [**Pride avatar post**](/blog/seasonal-avatar-borders) — AI handled the image transformation boilerplate while I focused on the creative concept.
2. The [**GitHub avatar sync post**](/blog/github-image-sync) — AI automated tedious API calls and formatting while I refined the logic.
